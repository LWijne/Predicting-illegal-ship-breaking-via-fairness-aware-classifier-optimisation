...
theta_list = np.arange(0.0, 0.11, 0.01)
...
print("auc_fal_setE_adult =", auc_list)
print("sdp_fal_setE_adult =", sdp_list)
print("std_auc_fal_setE_adult =", std_auc_list)
print("std_sdp_fal_setE_adult =", std_sdp_list)
