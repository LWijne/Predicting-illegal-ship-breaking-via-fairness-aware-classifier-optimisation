...
for th in theta_list:
    roc_auc, strong_dp, std_auc, std_sdp = neural_network_(th)
...
print("auc_nn_setD_adult =", auc_list)
print("sdp_nn_setD_adult =", sdp_list)
print("std_nn_setD_adult =", std_auc_list)
print("std_nn_setD_adult =", std_sdp_list)
