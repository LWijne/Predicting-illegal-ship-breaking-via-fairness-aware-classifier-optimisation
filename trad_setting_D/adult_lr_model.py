...
for th in theta_list:
    roc_auc, strong_dp, std_auc, std_sdp = logistic_regression_(th)
...
print("auc_lr_setD_adult =", auc_list)
print("sdp_lr_setD_adult =", sdp_list)
print("std_auc_lr_setD_adult =", std_auc_list)
print("std_sdp_lr_setD_adult =", std_sdp_list)
